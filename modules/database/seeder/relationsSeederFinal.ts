...
import{BuidGenerator}from '../../utils/uuid copy/src/buid'
...
const modifiersARtypes = ["اختياري", "متعدد"];
...
function generateCustomerWallets(customerId) {
  customerWalletsArray.push({
    ...
    balance_previous_day: 0, //faker.finance.amount(0, 500, 2),
...
function generateStoreTag(i,storeUUID, tageId) {
  storeTagsArray.push({
    tag_id: tageId,
    store_id: storeUUID,
    internal_store_id: i,
...
function generateJsonbDataEnAr(ln, uuidObject) {
  ...
  function generateJsonModifierbDataEnAr(modifier_items) {
    ...
    let modifier_name_type = randomEnum(modifiersARtypes);
...
function StatisticsPreviousDayMultiGenerator(count) {
  for (let i = 1; i < count; i++) {
...
//console.log("customerWalletsArray : " ,customerWalletsArray);
//console.log("driver : " ,driversArray);
//console.log("driverwalletspreviousday : " ,generateDriverWalletsPreviousDay);
//console.log("driverPoint : " ,driverPointsArray);
//console.log("partnersArray : " ,partnersArray);
//console.log("storesArray : " ,storesArray);
//console.log("productsArray : " ,productsArray);
//console.log("storeWalletsArray : " ,storeWalletsArray);
//console.log("storeTagsArray : " ,storeTagsArray);
//console.log("trendsArray : " ,trendsArray);
