...
DROP TYPE IF EXISTS enum_order_status,enum_user_type,enum_day_of_week,enum_on_expense,
enum_coupon_type,enum_driver_transaction_type,enum_vehicle_type,enum_store_transaction_type,
enum_store_transaction_type,enum_trust_points_operation_type,enum_partner_status,
enum_trust_points_operation_type,enum_partner_status,enum_user_transaction_type,
enum_store_status,enum_orders_type,enum_payment_method CASCADE;
...
COPY order_status FROM 'e:\backend\modules/database/seeder/CSV/order_status.csv' DELIMITER ',' CSV HEADER;
COPY current_orders FROM 'e:\backend\modules/database/seeder/CSV/current_orders.csv' DELIMITER ',' CSV HEADER;
COPY past_orders FROM 'e:\backend\modules/database/seeder/CSV/past_orders.csv' DELIMITER ',' CSV HEADER;
COPY ratings FROM 'e:\backend\modules/database/seeder/CSV/ratings.csv' DELIMITER ',' CSV HEADER;
...
COPY order_financial_logs FROM 'e:\backend\modules/database/seeder/CSV/order_financial_logs.csv' DELIMITER ',' CSV HEADER;
COPY electronic_payment FROM 'e:\backend\modules/database/seeder/CSV/electronic_payment.csv' DELIMITER ',' CSV HEADER;
